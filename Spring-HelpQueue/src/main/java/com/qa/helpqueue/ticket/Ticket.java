...
public class Ticket {
	...
	public String toString() {
		return "Ticket [ID=" + ID + ", TicketTitle=" + TicketTitle + ", TicketAuthor=" + TicketAuthor + ", TicketTime="
				+ TicketTime + ", TicketDesc=" + TicketDesc + ", TicketUrgency=" + TicketUrgency + ", TicketTopic="
				+ TicketTopic + ", TicketStatus=" + TicketStatus + ", TicketTrainer=" + TicketTrainer
				+ ", TicketCohort=" + TicketCohort + "]";
	}
