...
echo ${db_endpoint}
echo ${password}
docker build --build-arg testdb_username=${testdb_username} db_username=${db_username} testdb_endpoint=${testdb_endpoint} db_endpoint=${db_endpoint} password=${password} -t backend:latest . 
