...
sudo -E testdb_endpoint=${testdb_endpoint} testdb_username=${testdb_username} password=${password} db_endpoint=${db_endpoint} db_username=${db_username} docker-compose up -d --build
